...
def send_welcome(message):
    bot.reply_to(message, """Salam, Azərbaycan Python istifadəçiləri qrupuna xoş gəlmisiniz. Mümkün əmr siyahısını görmək üçün /help yazın.
                            Bizi fesbukda da izləyə bilərsiniz.\n
